...
//======== MEU SINAL ADX_ERA =========
#include <Erasmo\Include\Expert\Signal\SignalADX_Era.mqh>
//--- available trailing
...
//================      input do meu sinal ADX     ========================
input int                Sinal_ADX_PeriodADX          =20;                    // Average Directional Index (20,...) Period of calculation
input double             Sinal_ADX_menorValor         =25;                    //Menor valor do sinal ADX
input double             Sinal_ADX_Weight             =0.8;                   //Peso do Sinal ADX valor pode variar de 0 até 1.0
...
//============= MEU SINAL ADICIONADO AO FILTRO  ===========
//--- Creating filter SignalADX_Era
CSignalADX_Era *filter5=new CSignalADX_Era;
if(filter5==NULL)
  {
   //--- failed
   printf(__FUNCTION__+": error creating filter4");
...
//--- Set filter parameters
filter5.PeriodADX_Era(Sinal_ADX_PeriodADX);
filter5.MenorADX_Era(Sinal_ADX_menorValor);
filter5.Weight(Sinal_ADX_Weight);
